...
type TMDBClient interface {
	...
	GetSearchCollections(id string, urlOptions map[string]string) (*SearchCollections, error)
	GetSearchCompanies(id string, urlOptions map[string]string) (*SearchCompanies, error)
	GetSearchKeywords(id string, urlOptions map[string]string) (*SearchKeywords, error)
	GetSearchMovies(id string, urlOptions map[string]string) (*SearchMovies, error)
	GetSearchMulti(id string, urlOptions map[string]string) (*SearchMulti, error)
	GetSearchPeople(id string, urlOptions map[string]string) (*SearchPeople, error)
	GetSearchTVShow(id string, urlOptions map[string]string) (*SearchTVShows, error)
